...
public interface SmestajRepository extends JpaRepository<Smestaj, Long> {
	...
	@Query(value="SELECT DISTINCT SMESTAJ.VERSION, SMESTAJ.ID, SMESTAJ.ADRESA, SMESTAJ.BROJ_OCENA, SMESTAJ.DRZAVA, SMESTAJ.GMAP_URL, SMESTAJ.GRAD, SMESTAJ.NAZIV, SMESTAJ.OPIS, SMESTAJ.REJTING, SMESTAJ.ZVEZDICE, SMESTAJ.TIP_ID, SMESTAJ.VLASNIK_ID"
